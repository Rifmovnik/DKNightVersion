...
- (void)viewDidLoad {
    ...
    [button dk_setTitleColor:DKColorPickerWithKey(TINT) forState:UIControlStateNormal];
    [switchButton dk_setTitleColor:DKColorPickerWithKey(TINT) forState:UIControlStateNormal];
